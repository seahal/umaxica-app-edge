  ...
  it("should read .dev.vars environment variables", async () => {
    ...
    testApp.get('/', (c) => {
      ...
      const mockEnv = {
        ...
        WWW_CORPORATE_URL: "com.localhost:3300",
        WWW_SERVICE_URL: "app.localhost:3300",
        WWW_STAFF_URL: "org.localhost:3300"
      }
    ...
    expect(data.envVars.WWW_CORPORATE_URL).toBe("com.localhost:3300")
    expect(data.envVars.WWW_SERVICE_URL).toBe("app.localhost:3300")
    expect(data.envVars.WWW_STAFF_URL).toBe("org.localhost:3300")
  })
})