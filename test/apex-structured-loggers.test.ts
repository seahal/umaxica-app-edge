...
import { apexStructuredLogger as appLogger } from '../app/apex/src/structured-logger';
import { apexStructuredLogger as comLogger } from '../com/apex/src/structured-logger';
import { apexStructuredLogger as netLogger } from '../net/apex/src/structured-logger';
import { apexStructuredLogger as orgLogger } from '../org/apex/src/structured-logger';
...
describe.each(loggers)('%s apex structured logger', (_service, middleware) => {
