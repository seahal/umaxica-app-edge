/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 55ddd4e5218f4874c2a81623e63fe151)
// Runtime types generated with workerd@1.20260804.1 2026-05-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
  RATE_LIMITER: RateLimit;
  IMAGES: ImagesBinding;
  REVISION: WorkerVersionMetadata;
  ASSETS: Fetcher;
  EDGE_ENV: 'development' | 'vpc' | 'test' | 'production';
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'EDGE_ENV' | 'NODE_ENV' | 'BRAND_NAME'>
  > {}
}
