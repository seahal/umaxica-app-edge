/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 418f99b8128bb4ebb8111c86d1fd64d3)
// Runtime types generated with workerd@1.20260730.1 2026-05-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
  RATE_LIMITER: RateLimit;
  IMAGES: ImagesBinding;
  REVISION: WorkerVersionMetadata;
  ASSETS: Fetcher;
  CLOUDFLARE_ENV?: 'development' | 'preview' | 'test' | 'production';
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'CLOUDFLARE_ENV' | 'NODE_ENV' | 'BRAND_NAME'>
  > {}
}
