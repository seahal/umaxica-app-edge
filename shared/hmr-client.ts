...
import { config, type Domain, env } from "./config";
...
class HMRState {
	...
	private readonly enableVisualFeedback: boolean;
	...
	private createIndicator(text: string, backgroundColor: string): HTMLElement {
 ...
 */
export function createHMRScript(domain?: Domain): string {
 ...
 */
export function setupServerHMR(domain?: Domain) {
 ...
 */
export { config, type Domain } from "./config";
