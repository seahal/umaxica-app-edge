...
export default function Preference() {
	...
	return (
		<SettingLayout
			title="環境設定"
			description="アプリの表示や動作に関する設定を変更できます"
		>
			{/* 表示設定 */}
			<SettingSection
				title="表示設定"
				description="テーマやカラースキームの設定"
			>
				{/* ダークモード */}
				<SettingItem
					label="ダークモード"
					description="画面を暗い色調で表示します"
				>
					<Switch
						isSelected={darkMode}
