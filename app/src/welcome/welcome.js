		...
		children: _jsxs("div", {
			...
			children: [
				...
				_jsx("div", {
					...
					children: _jsxs("nav", {
						className:
							"rounded-3xl border border-gray-200 p-6 dark:border-gray-700 space-y-4",
						children: [
							_jsx("p", {
								className:
									"leading-6 text-gray-700 dark:text-gray-200 text-center",
							...
							_jsxs("ul", {
								children: [
									...
									_jsx("li", {
										className: "self-stretch p-3 leading-normal",
										children: message,
									}),
								],
							}),
...
const resources = [
	{
		...
		icon: _jsxs("svg", {
			...
			fill: "none",
			className:
				"stroke-gray-600 group-hover:stroke-current dark:stroke-gray-300",
			children: [
				_jsx("title", { children: "React Router Documentation" }),
				_jsx("path", {
	...
	},
	{
		...
		icon: _jsxs("svg", {
			...
			className:
				"stroke-gray-600 group-hover:stroke-current dark:stroke-gray-300",
			children: [
				_jsx("title", { children: "Join Discord Community" }),
				_jsx("path", {
