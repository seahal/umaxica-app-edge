...
describe('GET /about', () => {
  it('returns the COM about HTML document with key metadata', async () => {
    ...
    expect(body).toContain('<title>About — UMAXICA (COM)</title>');
    expect(body).toContain(
      '<meta name="description" content="umaxica.com is a UMAXICA platform domain. Services and content are available on dedicated subdomains"',
    );
