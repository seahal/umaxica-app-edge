...
describe('application shell', () => {
  ...
  it('gives the footer two layers: a named utility nav and the site identity', () => {
    ...
    expect(
      within(contentinfo).getByRole('link', { name: 'https://info-jp.umaxica.com/' }),
    ).toHaveAttribute('href', 'https://info-jp.umaxica.com/');
  });
...
describe('/about', () => {
  ...
  it('names the page in the title without naming the surface or the runtime', () => {
    ...
    expect(headTitleOf(aboutRoute)).toBe('このサイトについて — UMAXICA (COM)');
