/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 9dabab7b34f63b0ebad44dcf00d87909)
// Runtime types generated with workerd@1.20260801.1 2026-05-13 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
  RATE_LIMITER: RateLimit;
  IMAGES: ImagesBinding;
  REVISION: WorkerVersionMetadata;
  ASSETS: Fetcher;
  CLOUDFLARE_ENV: 'development' | 'vpc' | 'test' | 'production';
