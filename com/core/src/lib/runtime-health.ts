 ...
 * not call Rails, VPC, KV, or any other hop — Core still serves its own
 * documents when Rails is down, and a downstream outage must not mark a
 * healthy Worker unready or restart it.
 */
